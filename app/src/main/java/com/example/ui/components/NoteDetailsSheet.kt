        ...
        Column(
            ...
            Surface(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        Text(
                            text = "Export Note as PDF",
                            fontSize = 15.sp,
                            fontWeight = FontWeight.SemiBold
                        )
                        Text(
                            text = "Generates formatted PDF document with tree hierarchy",
                            fontSize = 12.sp,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
            ...
            Surface(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Turn opened outline notes and nodes into a visual interactive mind map",
                            fontSize = 12.sp,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
            ...
            Surface(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Turn outline notes into flip cards for active recall and studying",
                            fontSize = 12.sp,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
            ...
            Surface(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Turn outline note into structured presentation slide deck",
                            fontSize = 12.sp,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
